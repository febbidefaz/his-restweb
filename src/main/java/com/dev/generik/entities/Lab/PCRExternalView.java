...
@Entity
@Table(name = "WSPCREKTERNALVIEW")

public class PCRExternalView {
	@Id
	...
	public PCRExternalView() {
		super();
	}

	/*
	 * public PCRExternalView(Long id, String nama, String alamat, Date tgllahir ,
	 * Date tgl, String instansi, String ktp, String hasil, String nik ) {
	 * 
	 * super(); this.id = id; this.nama = nama; this.alamat = alamat; this.tgllahir
	 * = tgllahir; this.tgl = tgl; this.instansi = instansi; this.ktp = ktp;
	 * this.hasil = hasil; this.nik = nik;
	 * 
	 * }
	 */
