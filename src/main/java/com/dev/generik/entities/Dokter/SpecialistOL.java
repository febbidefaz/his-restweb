...
@Entity
@Table(name = "WSSPECIALISTOL")
public class SpecialistOL {
	@Id
	@Column(name = "Id")
	private Long id;
	...
	public String getBiayaOL() {
		return biayaOL;
	}

	public void setBiayaOL(String biayaOL) {
		this.biayaOL = biayaOL;
	}
