...
public class ContensTabTemplate implements Serializable {
	/**
	 * 
	 */
	...
	public ContensTabTemplate() {}
	
	public ContensTabTemplate(Long id, String mfdtd, String kode, Float qty, Float rasio) {
		this.id = id;
		this.mfdtd = mfdtd;
		this.kode = kode;
		this.qty = qty;		
