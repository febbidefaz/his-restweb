...
public class ResepOL {
	...
	public ResepOL (Long id, Date tgl, Date jam, Long idDokter, Long kelasID, Long roomID, String manual, Boolean racikan, String ketInap) {
		this.id = id;
		this.tgl = tgl;
		this.jam = jam;
