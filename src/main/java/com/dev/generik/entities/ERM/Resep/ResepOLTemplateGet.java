...
public class ResepOLTemplateGet {
	...
	public ResepOLTemplateGet() {}
	
	public ResepOLTemplateGet (Long id, Long idDokter, String nama, Boolean approved, Boolean racikan) {
		this.id = id;
